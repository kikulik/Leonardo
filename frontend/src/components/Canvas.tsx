...
/** Pin Y inside the BODY: evenly spaced with equal margins (no header in any math) */
...
function minBodySizeForDevice(d: Device) {
  ...
  // inner height must hold (count+1) spacing comfortably
...
export function Canvas({
  ...
  // ---------- overlay viewBox so off-screen lines are not clipped ----------
